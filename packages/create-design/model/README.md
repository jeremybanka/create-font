...
non-uniform scaling. `projectDesignObjectCornerResolutions()` reports intended
and applied amounts so editors can disclose temporary contour clamping without
discarding the authored preference.
