				...
				<keyboard-help>
					{routeName === "canvas"
						? tilingStatus.management
							...
							: `1–= Hotbar · Q Pen · V Select · T Transform · Shift+A Align · Shift+R Reverse · Shift+F Make First · Shift+Space Tiles${tilingStatus.dirty ? " (unsaved)" : ""} · ${MOD_KEY_LABEL}+Shift+P Commands`
