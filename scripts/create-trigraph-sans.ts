...
function makeTrigraphSans(): EditorFontSource {
	...
	return {
		...
		names: {
			...
			subfamily: `Razor`,
			uniqueId: `TRIG:Trigraph Sans:1.000`,
			fullName: `Trigraph Sans Razor`,
			version: `Version 1.000`,
			postScriptName: `TrigraphSans-Razor`,
			typographicFamily: `Trigraph Sans`,
...
const projectRoot = resolve(import.meta.dir, `..`, `fonts`, `trigraph-sans`)
const split = splitEditorFontSource(makeTrigraphSans())
...
Trigraph Sans is the repository's live development font. It is a small,
